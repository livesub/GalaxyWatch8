...
14. 하단 알약2: 삼성 헬스 걸음 수 — 알약1과 동일 스타일(독립 타원, 타이틀 내장), 폭은 위 박스 크기 통일 규칙에 따라 알약1/3과 동일(96px)
15. 하단 알약3: 심박수(HEART_RATE) 단독 확정(스트레스 미구현) — 알약1/2와 동일 스타일, 폭은 알약1/2와 동일(96px)
